...
# 加载基础数据
riding_data = pd.read_csv('附件数据/日汇总骑行数据.csv', encoding='utf-8-sig')
inventory_data = pd.read_csv('附件数据/每日初始库存.csv', encoding='utf-8-sig')
weather_data = pd.read_csv('附件数据/天气数据.csv', encoding='utf-8-sig')
target_inventory = pd.read_csv('附件数据/站点期望库存.csv', encoding='utf-8-sig')
station_info = pd.read_csv('附件数据/站点基础信息.csv', encoding='utf-8-sig')
distance_matrix = pd.read_csv('附件数据/站点距离.csv', index_col=0, encoding='utf-8-sig')
